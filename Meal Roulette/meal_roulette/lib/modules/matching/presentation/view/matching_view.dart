...
class _MatchingViewState extends State<MatchingView> {
  ...
  // Demo data
  late final List<MatchModel> activeMatches;
  late final List<MatchModel> pastMatches;
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<MatchModel>>(
          ...
          builder: (context, snapshot) {
            ...
            return listToShow == null ? const Center(child: Text('No matches found.')) : SafeArea(
              child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ClipOval(child: GestureDetector(child: Text(user.avatarUrl ?? '🧑', style: const TextStyle(fontSize: 36)), onTap: () {
                                          ...
                                          Wrap(
                                            spacing: 4,
                                            runSpacing: 4,
                                            children: ['Photography', 'Hiking', 'Coffee', 'Technology']
                                                .map(
                                                    (interest) =>
